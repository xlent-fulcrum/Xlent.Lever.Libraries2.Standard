...
namespace Xlent.Lever.Libraries2.Standard.Storage.Model
{
    ...
    public interface ICrud<TStorable, in TId>
        where TStorable : IStorable<TId>
    {
        ...
        /// <returns>The new item as it was saved, including an updated <see cref="IETag.ETag"/></returns>
        ...
        /// <returns>The updated item as it was saved, including an optional updated <see cref="IETag.ETag"/></returns>
        ...
        /// <exception cref="FulcrumConflictException">Thrown if the <see cref="IETag.ETag"/> for <paramref name="item"/> was outdated.</exception>
